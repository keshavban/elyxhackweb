...
const AIHealthPredictor: React.FC<AIHealthPredictorProps> = ({ onClose }) => {
  ...
  const getGraphImage = (metric: string | null) => {
    switch (metric) {
      case 'cholesterol':
        return '/files_6195441-1755420076667-image.png';
      case 'bp':
        return '/files_6195441-1755420100052-image.png';
      case 'heartrate':
        return '/files_6195441-1755420115265-image.png';
      default:
        return '/files_6195441-1755419932489-image.png'; // Wellness Index
    }
  };
  ...
  const getGraphDescription = (metric: string | null) => {
    switch (metric) {
      ...
      default:
        return 'Comprehensive wellness prediction based on your health data, lifestyle patterns, and intervention responses. The AI model forecasts your health trajectory over the next 12 months.';
    }
  };
        ...
        <div className="p-8">
          ...
          <div className="bg-gray-50 rounded-2xl p-6 mb-8">
            ...
            <div className="bg-white rounded-xl p-4 shadow-inner">
              <img 
                src={getGraphImage(selectedMetric)}
