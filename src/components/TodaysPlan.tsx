      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-in slide-in-from-top duration-300">
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">{todaysPlan.diet.breakfast}</p>
                </div>
                <div className="text-green-600 font-semibold">7:30 AM</div>
              </div>
              <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                <div>
                  <span className="font-semibold text-gray-800">Lunch</span>
                  <p className="text-gray-600 text-sm">{todaysPlan.diet.lunch}</p>
                </div>
                <div className="text-green-600 font-semibold">12:30 PM</div>
              </div>
              <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                <div>
                  <span className="font-semibold text-gray-800">Dinner</span>
                  <p className="text-gray-600 text-sm">{todaysPlan.diet.dinner}</p>
                </div>
                <div className="text-green-600 font-semibold">7:00 PM</div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg p-4">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-orange-600 font-bold">{todaysPlan.exercise.activity}</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold text-gray-800">Duration</div>
                  <div className="text-orange-600 font-bold">{todaysPlan.exercise.duration}</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold text-gray-800">Goal</div>
                  <div className="text-orange-600 font-bold text-sm">{todaysPlan.exercise.goal}</div>
                </div>
              </div>
          ...
          <div className="bg-blue-50 rounded-xl p-6">
            ...
            <div className="bg-white rounded-lg p-4">
              <p className="text-gray-700 leading-relaxed">{todaysPlan.healthFact}</p>
            </div>
          </div>

          {/* Action Buttons */}
          <div className="flex space-x-4">
            <button className="flex-1 bg-gradient-to-r from-green-500 to-green-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg transition-all">
              Mark Diet Complete
            </button>
            <button className="flex-1 bg-gradient-to-r from-orange-500 to-orange-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg transition-all">
              Log Exercise
            </button>
          </div>
        </div>
